...
#class TinyGecko:
    #def __init__(self):
        ...
        #self.position = 0
        #self.win.set_events(gtk.gdk.KEY_PRESS)
        ...
        #self.win.connect("key-press-event", self.keyboard_cb)
    ...
    #def keyboard_cb(self, widget, event, data=None):
        ...
        #elif keyname == "y":
            #print "copy to clipboard"
            #if os.system('echo "%s" | xclip -i' % self.moz.get_location()):
                #print "#fail"
        #elif keyname == "f":
            #print "go to firefox"
            #if os.system("firefox %s" % self.moz.get_location()):
                #print "#fail"
    ...
    #def next(self):
        #print "was:", self.position
            ...
            #self.position += 1
            #print "loading:", self.urls[self.position][:-1]
            #self.moz.load_url(self.urls[self.position][:-1])
        #elif self.position == len(self.urls) - 1:
            #print "show finish", self.position + 1
            #data = '<html><head><title>Hello</title></head><body><center><h1>Finish</h1><h3>One more step forward and the browser will quit</h3></center></body></html>'
    ...
    #def home_page(self):
        #self.moz.load_url(self.urls[0][:-1])
